...
- `signboard-vue/src/lib/components/RichTextEditor.vue` - Controlled Tiptap Markdown card-notes editor with native nested task checkboxes, link editing, raw URL decorations, and external-body refresh support.
