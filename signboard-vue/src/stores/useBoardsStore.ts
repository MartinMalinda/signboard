...
- [ ] (due: ${starterDueDate(3)}) Review the dated checklist items in this card
...
- Cmd/Ctrl + F opens the quick switcher search
...
export const useBoardsStore = defineStore('boards', () => {
  ...
  async function activateBoard(path: string) {
    ...
    console.error('[boards activate authorized]', normalized, authorized)
