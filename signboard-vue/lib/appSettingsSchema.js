...
const appSettingsSchema = globalThis.SignboardAppSettingsSchema;
export default appSettingsSchema;
export const {
  APP_SETTINGS_FILE_NAME, APP_SETTINGS_VERSION, DEFAULT_AI_SETTINGS,
  DEFAULT_EXTERNAL_PUBLISHED_CALENDAR_PORT, DEFAULT_EXTERNAL_PUBLISHED_CALENDAR_SETTINGS,
  DEFAULT_NOTIFICATION_SETTINGS, DEFAULT_QUICK_ADD_SETTINGS, DEFAULT_SMART_CARD_ACTIONS,
  DEFAULT_SMART_CARD_ACTION_TARGET, DEFAULT_TOOLTIPS_ENABLED, CUSTOM_SMART_CARD_ACTION_LIMIT,
  GLOBAL_SHORTCUT_MAX_LENGTH, SMART_CARD_ACTION_LABEL_MAX_LENGTH, SMART_CARD_ACTION_PROMPT_MAX_LENGTH,
  SMART_CARD_ACTION_TARGETS, SMART_CARD_ACTION_TARGET_LABELS, cloneDefaultAiSettings,
  cloneDefaultSmartCardActions, isObject, normalizeAiProvider, normalizeAiSettings,
  normalizeAppSettings, normalizeExternalPublishedCalendarPort,
  normalizeExternalPublishedCalendarSettings, normalizeExternalPublishedCalendarToken,
  normalizeGlobalShortcutAccelerator, normalizeNotificationSettings, normalizeNotificationTime,
  normalizeOllamaModel, normalizeOllamaSettings, normalizeOllamaUrl, normalizeQuickAddSettings,
