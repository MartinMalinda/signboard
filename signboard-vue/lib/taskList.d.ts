...
export interface TaskListItem { start: string; due: string; contentWithoutDateMarkers: string; isCompleted: boolean; lineIndex: number; lineStart: number; line: string; [key: string]: unknown }
