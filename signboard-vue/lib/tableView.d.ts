...
export const TABLE_SCORE_COLUMNS: readonly { id: string; field: string; label: string }[]
...
export function formatTableScore(value: unknown): string
...
export function createTableEntries(lists: unknown[], isCompletedList?: (listName: string) => boolean, v2Cards?: unknown[], dashboardSectionId?: string): any[]
