  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        workType: { type: 'string', description: 'Optional V2 work type.' },
...
async function handleToolCall(config, name, args = {}) {
  ...
  switch (toolName) {
    ...
    case 'signboard.create_card': {
      ...
      const hasV2Overrides = args.kind != null || args.workType != null || args.priorityClass != null || args.effortPoints != null;
      if (v2Profile || hasV2Overrides) {
        ...
        const metadata = {
          ...
          work_type: String(args.workType || defaults.workType || 'product'),
    ...
    case 'signboard.duplicate_card': {
      ...
      const nextTitle = Object.prototype.hasOwnProperty.call(args, 'title')
        ? (String(args.title || '').trim() || sourceTitle)
