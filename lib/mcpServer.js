...
const INTERNAL_TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description: 'Read board label, theme, workflow, and External Published Calendar inclusion settings from the board root .board.json manifest.',
    inputSchema: {
      type: 'object',
      additionalProperties: false,
      required: ['boardRoot'],
  ...
  },
  {
    ...
    description: 'Update board settings (labels, themeOverrides, workflow, and/or External Published Calendar inclusion).',
    inputSchema: {
      type: 'object',
      additionalProperties: false,
      required: ['boardRoot'],
...
async function handleToolCall(config, name, args = {}) {
  ...
  switch (toolName) {
    ...
    case 'signboard.create_card': {
      ...
      const nextFrontmatter = prepareNewCardFrontmatter(frontmatter);
